...
| Code Signing | _TBD — required before distribution_ |
| Auto-update | electron-updater or Squirrel via update server / GitHub releases |
| Data Storage | app.getPath('userData') — JSON settings, SQLite (better-sqlite3), or electron-store |
| Distribution | Website download, GitHub releases, Microsoft Store, winget |

### Native Integrations
_None specified — consider tray icon, notifications, file associations, deep links, global shortcuts._
