...
This folder is the generated context pack for **Notesmith** (Python Script). It was produced by Context Editor from a structured project brief — deterministic generation, no AI calls. Read it before writing any code.
