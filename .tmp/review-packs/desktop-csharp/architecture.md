...
## Data Flow
1. The user interacts with the UI (WinUI 3, WPF, MAUI, WinForms).
2. UI events reach core logic through the framework boundary: XAML binding → ViewModel command → service/model layer.
...
- Build: dotnet build / MSBuild (Visual Studio solution)
