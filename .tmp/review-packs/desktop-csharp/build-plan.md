...
Definition of done: The solution builds clean in Visual Studio and delivers the MVP. View models and services pass unit tests. The UI stays responsive. An installer/package (MSIX or equivalent) is produced.
