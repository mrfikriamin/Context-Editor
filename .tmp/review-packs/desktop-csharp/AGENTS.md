...
This folder is the generated context pack for **Notesmith** (Desktop Application). It was produced by Context Editor from a structured project brief — deterministic generation, no AI calls. Read it before writing any code.
