...
Definition of done: The app builds and runs on all target OSes and delivers the MVP. Capabilities are minimal and documented. Rust passes clippy and tests; the frontend passes linting and type checking. Bundles are produced for each target.
