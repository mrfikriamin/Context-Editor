...
export const DOC_INGESTION_TOOLS: ContextToolOption[] = [
  {
    id: "markitdown",
...
export const GRAPH_TOOLS: ContextToolOption[] = [
  {
    id: "auto",
...
export const LINT_TOOLS: ContextToolOption[] = [
  {
    id: "markdownlint",
...
export function resolveContextTool(
